...
| 
| -------------------------------------------------------------------*/
	$appFolderPath = dirname(dirname(dirname(dirname(dirname(__FILE__)))));
	
	$config['img_path'] = '/multimedias/images/apps'; // Relative to domain name
	echo $config['upload_path'] = $appFolderPath . $config['img_path']; // Physical path. [Usually works fine like this]
